...
home_text_pm = f"""
✨ Kon'nichiwa! I'm {BOT_NAME} 🦋

I’m here to bring magic to your Telegram groups with anime vibes, admin powers, and cuteness overload!

Click the buttons below to explore all my commands and system stats 💫
"""
    ...
    if ctx.chat.type.value != "private":
        ...
        try:
            return await ctx.reply_photo(
                photo="https://files.catbox.moe/6inxw1.jpg",
...
Here’s everything I can do to brighten up your chats! Just click a button below to explore my powers ✨

Use the inline help menu to browse features by category 💫
""",
        keyb,
    )
